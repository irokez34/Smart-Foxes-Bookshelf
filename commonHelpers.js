import"./assets/modulepreload-polyfill-3cfb730f.js";import{a as n}from"./assets/vendor-1c5e86dd.js";const c="https://books-backend.p.goit.global/books/";async function i(){const o="top-books";return await n.get(`${c}${o}`)}const g=document.querySelector(".categories-books-all");document.querySelector(".categories-books-title");window.addEventListener("load",l);async function l(){try{const o=await i(),e=b(o.data);console.log("topBooks",o),d(e)}catch(o){console.log(o)}}function b(o=[]){return o.map(({list_name:e,books:t})=>`
